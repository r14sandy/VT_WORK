...
gint start()
{
	...
	gst_element_link (data.videoconv,data.clock);
	gst_element_link (data.clock,data.videosink);

	
	g_signal_connect (data.decoder, "pad-added", G_CALLBACK (on_pad_added), data.videoconv);
	g_signal_connect (data.videoconv, "pad-added", G_CALLBACK (on_pad_added), data.clock);
	g_signal_connect(data.clock, "pad-added", G_CALLBACK(on_pad_added), data.videosink);   
